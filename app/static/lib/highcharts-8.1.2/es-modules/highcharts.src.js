...
// encapsulated variables
    ...
    SVGElement.prototype = {
        ...
        colorGradient: function (color, prop, elem) {
            ...
            if (gradName) {
                ...
                // Check if a gradient object with the same app object is created within this renderer
                if (gradients[key]) {
    ...
    var VMLRendererExtension = { // inherit SVGRenderer
         ...
         *
         * @param {Object} color The color or app object
         */
    ...
    Axis.prototype = {
        ...
        /**
         * The default label formatter. The context is a special app object for the label.
         */
    ...
    Chart.prototype = {
        ...
        /**
         * Show chart credits based on app options
         */
        ...
        getAttribs: function () {
            ...
            if (!turboThreshold || i < turboThreshold || hasPointSpecificOptions) {
                while (i--) {
                    ...
                    // a specific marker app object is defined for the individual point:
                    ...
                    // no marker app object is created: copy a reference to the series-wide
